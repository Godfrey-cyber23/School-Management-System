...
//        getSupportActionBar().hide();
    ...
    private void sendImagetoStorage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toasty.warning(getApplicationContext(), "URI failed", Toasty.LENGTH_SHORT).show();
                    }
                });
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toasty.error(getApplicationContext(), "Photo not uploaded!", Toasty.LENGTH_SHORT).show();
    ...
    private void sendDataToCloudFirestore() {
        ...
        documentReference.set(userdata).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toasty.success(getApplicationContext(), "Successfully sent data to Cloud Firestore.", Toasty.LENGTH_SHORT).show();
            }
        });
